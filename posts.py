        ...
        if article:
            if draft_access or current_user.id == article.user_id:
                if request.method == "POST":
                    ...
                    git_check = save_changes(request.form['text'],fr"C:\Users\Professional\PycharmProjects\pythonProject\articles\article_{id}",request.form['commit'])
                    if git_check:
                        print("Успешное сохранение!")
                        print(get_file_history(fr"C:\Users\Professional\PycharmProjects\pythonProject\articles\article_{id}"))
                    else:
                        print("Что то не так!")
...
def get_file_history(id):
    return render_template("get_file_history.html", history=get_git_history(fr"C:\Users\Professional\PycharmProjects\pythonProject\articles\article_{id}"))
